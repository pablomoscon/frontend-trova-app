  ...
  return (
    <section className='bg-[#E5E6E4] text-gray-900 px-6 sm:px-12 py-20 sm:py-30'>
      <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center'>
        <div className='order-2 md:order-1 w-full flex justify-center hidden md:flex relative'>
          {!desktopLoaded && (
            <img
              src='/assets/trova_logo_placeholder.webp'
              alt='Placeholder'
              className='rounded-3xl shadow-xl object-cover w-full h-auto max-w-4xl lg:max-w-6xl absolute top-0 left-0'
            />
          )}
          <img
        ...
        <div className='flex flex-col gap-8 justify-start items-center md:items-start text-center md:text-left order-1'>
          ...
          <div className='w-full flex justify-center md:hidden py-6 relative'>
            {!mobileLoaded && (
              <img
                src='/assets/trova_logo_placeholder.webp'
                alt='Placeholder'
                className='rounded-3xl shadow-xl object-cover w-full h-auto max-w-md absolute top-0 left-0'
              />
            )}
            <img
              src='/assets/catalogo_trova.webp'
